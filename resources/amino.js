...
//@function add(anim) adds an animation to the scene. simply delegates to the Amino engine
Canvas.prototype.addAnim = function(node) {
    this.engine.addAnim(node);
    return this;
}
...
//@function stop() Stop playing the animation.
PropAnim.prototype.stop = function() {
	this.playing = false;
    if(this.engine) {
        this.engine.animationChanged();
    }
